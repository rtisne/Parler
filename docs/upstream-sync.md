...
| `(local)`    | Windows OpenBLAS runtime  | #24      | `24a95be`    | adapted  | No Melvynx commit; pinned OpenBLAS 0.3.31 and pkgconf 3.0.3 (`2a9d4d6`); x64/WOA64 MSI and NSIS bundles inspected |
